...
class PlayerGuidance:
    ...
    def __init__(self):
        ...
        self.context_tips = {
            "low_health": "你的生命值较低，建议先修炼恢复或使用药品",
            "low_mana": "法力不足，使用技能前请先恢复法力",
...
def enhance_player_experience(game_core):
    ...
    def enhanced_process_command(input_text: str):
        ...
        if game_core.game_state.player:
            ...
            context["player_health_percent"] = player.attributes.current_health / player.attributes.max_health
            context["player_mana_percent"] = player.attributes.current_mana / player.attributes.max_mana
