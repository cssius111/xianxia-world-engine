...
def create_builtin_functions() -> Dict[str, Dict[str, Any]]:
    ...
    return {
        ...
        "abs": {"args": 1, "func": abs, "description": "返回绝对值"},
        "sqrt": {
            "args": 1,
            "func": lambda x: math.sqrt(x) if x >= 0 else float("nan"),
            "description": "返回平方根",
        },
        "ceil": {"args": 1, "func": math.ceil, "description": "向上取整"},
        "floor": {"args": 1, "func": math.floor, "description": "向下取整"},
        # 随机函数
        "rand": {
            "args": 2,
        ...
        # 扩展数学函数
        "pow": {"args": 2, "func": pow, "description": "幂运算"},
        "log": {"args": 1, "func": math.log, "description": "自然对数"},
        "log10": {"args": 1, "func": math.log10, "description": "以10为底的对数"},
        "sin": {"args": 1, "func": math.sin, "description": "正弦函数"},
        "cos": {"args": 1, "func": math.cos, "description": "余弦函数"},
        "tan": {"args": 1, "func": math.tan, "description": "正切函数"},
        # 实用函数
        "round": {
            "args": 2,
