...
from xwe.core.events import EventBus, Event
...
class GameStateManager:
    ...
    def push_context(self, context_type: GameContext, data: Optional[Dict[str, Any]] = None) -> None:
        """
        推入新的游戏上下文
        ...
        # 触发监听器
        self._trigger_listeners('context_changed', {
    ...
    def set_location(self, location: str) -> None:
        ...
        self._trigger_listeners('location_changed', {
            'old': old_location,
            'new': location
        })
    ...
    def add_achievement(self, achievement_id: str) -> None:
        ...
        if achievement_id not in self.state.achievements:
            ...
            self._trigger_listeners('achievement_unlocked', {
    ...
    def update_npc_relationship(self, npc_id: str, change: int) -> None:
        ...
        self._trigger_listeners('relationship_changed', {
            'npc_id': npc_id,
            'old_value': old_value,
    ...
    def update_quest(self, quest_id: str, updates: Dict[str, Any]) -> None:
        ...
        if quest_id in self.state.quests:
            ...
            self._trigger_listeners('quest_updated', {
                'quest_id': quest_id,
                'updates': updates
            })
    ...
    def restore_snapshot(self, index: int = -1) -> bool:
        ...
        try:
            ...
            self.context_stack = [
                ContextInfo.from_dict(ctx) for ctx in snapshot['context_stack']
            ]
    ...
    def get_game_info(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'current_context': self.get_current_context().name if self.get_current_context() else None,
