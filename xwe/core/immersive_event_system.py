...
女修士似乎受了伤，情况不太妙...
                    ...
                    choices=[
                        EventChoice(
                            id='help_fight',
                            text='立即出手相助',
                            consequence='join_battle'
                        ),
                        EventChoice(
                            id='observe',
                            text='先观察情况',
                            consequence='observe_scene'
                        ),
                        EventChoice(
                            id='leave',
                            text='悄悄离开',
                            consequence='leave_scene'
                        )
                    ]
                )
            ],
    ...
    def complete_event(self):
        ...
        if self.current_event:
            ...
            if self.current_event in self.event_callbacks:
                self.event_callbacks[self.current_event](self.player_choices.get(self.current_event, []))
