...
"""
    ...
    def _build_system_prompt(self, response_type: ResponseType, context: GameContext) -> str:
        """构建系统提示"""
        base_prompt = """
...
""",
    ...
    def parse_ai_response(self, response: str, response_type: ResponseType) -> Dict[str, Any]:
        """解析AI响应"""
        ...
        if response_type == ResponseType.COMMAND_PARSE:
            ...
            return {"narrative": narrative, "changes": self._parse_changes(changes)}
    ...
    def _load_style_guides(self) -> Dict[str, str]:
        """加载风格指南"""
        return {"default": "标准仙侠风格", "ancient": "古风典雅", "modern": "现代网文风"}
    ...
    def _fuzzy_parse_command(self, response: str) -> Dict[str, Any]:
        """模糊解析命令"""
        # 简单的降级处理
        return {"command": "unknown", "confidence": 0.3, "raw_response": response}
