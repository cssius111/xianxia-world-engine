...
class NPCSystemV3:
    ...
    def update_dialogue_state(self, player_id: str, npc_id: str, 
                             new_node: str, flags: Optional[Dict] = None):
        """更新对话状态"""
    ...
    def modify_relationship(self, player_id: str, npc_id: str, amount: int):
        ...
        logger.info(f"Relationship between {player_id} and {npc_id} changed: {current} -> {new_value}")
...
class NPC:
    ...
    def _load_dialogue_tree(self) -> Dict[str, Any]:
        ...
        # TODO: 从单独的对话文件加载
        # 现在使用模板中的简单对话
        return self.template.get("dialogue_tree", {
            "greeting": {
