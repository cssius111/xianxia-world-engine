...
class EmotionSystem:
    ...
    def trigger_emotion(
        self, npc_id: str, emotion: EmotionType, intensity: float, reason: str = ""
    ):
        """
        触发情绪
        ...
        logger.debug(
            f"NPC {npc_id} 情绪变化: {emotion.value} " f"(强度: {intensity}, 原因: {reason})"
        )

    def react_to_event(
        self, npc_id: str, event_type: str, event_data: Dict[str, Any]
    ...
    def get_emotion_modifier_for_dialogue(self, npc_id: str) -> Dict[str, float]:
        ...
        modifiers = {"friendliness": 0.0, "patience": 0.0, "generosity": 0.0, "trust": 0.0}
    ...
    def get_emotion_description(self, npc_id: str) -> str:
        ...
        descriptions = {
            ...
            EmotionType.ANGRY: {0.3: "眉头微皱", 0.6: "面色不悦", 0.8: "怒目而视", 1.0: "怒发冲冠"},
            EmotionType.FEARFUL: {
                0.3: "神色紧张",
                0.6: "面露惧色",
                0.8: "瑟瑟发抖",
            ...
            EmotionType.SAD: {0.3: "神情落寞", 0.6: "愁眉不展", 0.8: "黯然神伤", 1.0: "泪流满面"},
            ...
            EmotionType.NEUTRAL: {0.0: "表情平静", 1.0: "面无表情"},
        }
    ...
    def get_dialogue_modifiers(self, npc_id: str) -> dict:
        """获取对话修饰符"""
        return {"friendliness": 1.0, "price_modifier": 1.0, "quest_reward_modifier": 1.0}
