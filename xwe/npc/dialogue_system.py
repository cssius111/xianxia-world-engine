...
class DialogueNode:
    ...
    def get_next_node(
        self, context: Dict[str, Any], choice_id: Optional[str] = None
    ) -> Optional[str]:
        """获取下一个节点ID"""
    ...
    def _apply_effects(self, effects: Dict[str, Any], context: Dict[str, Any]) -> None:
        ...
        for effect_type, value in effects.items():
            if effect_type == "relationship_change":
                ...
                # 给予物品（需要物品系统支持）
                context.setdefault("rewards", []).append({"type": "item", "id": value})

            elif effect_type == "give_exp":
                # 给予经验
                context.setdefault("rewards", []).append({"type": "exp", "amount": value})
...
class DialogueSystem:
    ...
    def __init__(self) -> None:
        """初始化对话系统"""
        self.dialogue_trees: Dict[str, Dict[str, DialogueTree]] = (
            {}
        )  # npc_id -> dialogue_id -> tree
        ...
        merchant_dialogue = {
            "nodes": [
                ...
                },
                {
                    ...
                    "text": "",
                    "choices": [
                        {"id": "buy", "text": "我想买点东西", "next_node": "show_goods"},
                        {"id": "sell", "text": "我有些东西要卖", "next_node": "check_items"},
                        {
                            "id": "chat",
                            "text": "聊聊最近的消息",
                            "next_node": "gossip",
                        ...
                        {"id": "leave", "text": "没什么，告辞", "next_node": "goodbye"},
                    ],
                },
                {
                    "id": "show_goods",
        ...
        guard_dialogue = {
            "nodes": [
                ...
                },
                {
                    ...
                    "text": "",
                    "choices": [
                        {"id": "ask_news", "text": "最近有什么消息吗？", "next_node": "tell_news"},
                        {"id": "leave", "text": "没事，告辞", "next_node": "goodbye"},
                    ],
                },
                {
                    "id": "ask_weak",
                    ...
                    "text": "",
                    "choices": [
                        {"id": "explain", "text": "我是来历练的散修", "next_node": "warn"},
                        {"id": "leave", "text": "打扰了，我这就走", "next_node": "goodbye"},
                    ],
                },
                {
                    "id": "tell_news",
                ...
                {"id": "goodbye", "type": "text", "speaker": "npc", "text": "去吧。"},
            ],
            "start_node": "start",
        }
    ...
    def start_dialogue(
        self, player_id: str, npc_id: str, dialogue_id: Optional[str] = None
    ) -> Optional[DialogueNode]:
        """
        开始对话
    ...
    def advance_dialogue(
        self, player_id: str, context: Dict[str, Any], choice_id: Optional[str] = None
    ) -> Optional[DialogueNode]:
        """
        推进对话
        ...
        "default": {
            "nodes": [
                ...
                },
                {
                    ...
                    "text": "",
                    "choices": [
                        {"id": "buy", "text": "我需要一些修炼物资", "next_node": "show_goods"},
                        {
                            "id": "ask_cultivation",
                            "text": "前辈可否指点一下修炼之道？",
                        ...
                        {"id": "leave", "text": "多谢前辈，我先走了", "next_node": "goodbye"},
                    ],
                },
                {
                    "id": "show_goods",
                ...
                },
                {
                    ...
                    "effects": {"add_flag": "know_qingyun_recruitment", "relationship_change": 3},
                    "next_node": "menu",
                },
                {
                    "id": "goodbye",
