...
class TradingSystem:
    ...
    def _init_default_shops(self) -> None:
        ...
        wang_shop = Shop(
            ...
            items=[
                ...
                ShopItem(
                    "skill_book_basic_meditation", quantity=1, requirements={"min_relationship": 10}
                ),
            ],
        )
    ...
    def buy_item(
        self, shop_id: str, item_id: str, quantity: int, player_context: Dict[str, Any]
    ) -> Dict[str, Any]:
        """
        购买物品
        ...
        Returns:
            交易结果
        """
        result = {"success": False, "message": "", "cost": 0, "items": []}
        ...
        result["items"] = [{"id": item_id, "name": item_data.name, "quantity": quantity}]
    ...
    def sell_item(self, shop_id: str, item_id: str, quantity: int) -> Dict[str, Any]:
        ...
        Returns:
            交易结果
        """
        result = {"success": False, "message": "", "income": 0}
