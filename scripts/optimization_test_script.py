...
class OptimizationTester:
    ...
    def test_1_imports(self):
        ...
        try:
            ...
            # 测试确认管理器
            from xwe.core.confirmation_manager import (
                ConfirmationManager,
    ...
    def test_3_system_manager(self):
        ...
        try:
            ...
            if speed_bonus == 2.0 and breakthrough_bonus == 1.5 and has_feature:
                ...
                print(
                    f"❌ 系统管理器逻辑错误 - 速度:{speed_bonus}, 突破:{breakthrough_bonus}, 功能:{has_feature}"
                )
                return False
    ...
    def test_4_confirmation_manager(self):
        ...
        try:
            ...
            if success and executed and len(pending) == 1:
                ...
                print(
                    f"❌ 确认机制逻辑错误 - 成功:{success}, 执行:{executed}, 待确认:{len(pending)}"
                )
                return False
    ...
    def test_7_backup_verification(self):
        ...
        try:
            backup_files = ["xwe/core/game_core.py.backup", "xwe/core/character.py.backup"]
    ...
    def test_10_integration_test(self):
        ...
        try:
            ...
            conf_id = confirmation_manager.request_confirmation(
                "购买丹药", "花费500灵石购买筑基丹", spend_callback, {"cost": 500}
            )
            ...
            if final_stones == expected_stones and confirmed and bonus == 3.0:
                ...
                print(
                    f"❌ 最终状态错误 - 灵石:{final_stones}(期望{expected_stones}), 确认:{confirmed}, 加成:{bonus}"
                )
                return False
