...
if [ -f "import_grafana_dashboard.sh" ] && [ -f "grafana_dashboard_xwe.json" ]; then
...
echo -e "  • 使用 'docker-compose -f docker-compose.monitoring.yml logs -f' 查看日志"
echo -e "  • 使用 'docker-compose -f docker-compose.monitoring.yml down' 停止监控栈"
