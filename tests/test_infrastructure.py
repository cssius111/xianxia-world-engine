...
from xwe.core.services import ServiceContainer, IGameSystem
from xwe.core.events import EventDispatcher, Event, EventPriority
import asyncio
...
def test_service_container():
    ...
    container.register('dependent_service', 
                      lambda c: DependentService(c.get('test_service')))
