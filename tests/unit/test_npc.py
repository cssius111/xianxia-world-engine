...
from xwe.npc.dialogue_system import DialogueTree, DialogueNode, DialogueNodeType, DialogueChoice
...
def test_trading_system():
    ...
    # 测试购买
    result = trading_system.buy_item(
        "wang_basic_shop", 
        "healing_pill_low", 
        2,
        player_context
    ...
    # 测试出售
    sell_result = trading_system.sell_item(
        "wang_basic_shop",
        "iron_ore",
        5
    )
