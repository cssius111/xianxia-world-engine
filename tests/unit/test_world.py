...
from xwe.world import WorldMap, LocationManager, EventSystem, AreaType, Area
...
def test_location_manager():
    ...
    # 测试移动
    success, message = location_manager.move_entity(
        player.id, "tiannan_market", player_level=1
    )
