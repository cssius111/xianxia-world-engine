...
from xwe.core.roll_system import ROLL_DATA, CharacterRoller, RollResult
from xwe.core.roll_system.roll_utils import (
...
class TestRollSystem(unittest.TestCase):
    ...
    def test_weighted_random(self):
        """测试权重随机选择"""
        # 测试数据
        test_items = {"common": {"weight": 70}, "rare": {"weight": 25}, "epic": {"weight": 5}}
