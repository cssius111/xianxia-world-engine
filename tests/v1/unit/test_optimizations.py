...
def test_imports():
    ...
    try:
        # 测试新创建的系统模块
        from xwe.core.item_system import Item, ItemSystem, item_system
        from xwe.core.system_manager import system_manager
...
def test_item_system():
    ...
    try:
        from xwe.core.item_system import Item, item_system

        # 创建测试物品
        test_item = Item(id="spirit_stone", name="灵石", description="修炼必需的货币", value=1)
