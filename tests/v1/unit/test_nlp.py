...
def test_nlp_basic():
    ...
    nlp_config = NLPConfig(enable_llm=True, llm_provider="mock", fallback_to_rules=True)
...
def test_nlp_context():
    ...
    test_inputs = ["攻击低阶妖兽", "用剑气斩", "使用金刚护体", "攻击血少的那个"]
...
def test_nlp_suggestions():
    ...
    # 测试战斗中的建议
    combat_context = {"in_combat": True, "available_skills": ["剑气斩", "火球术"]}
