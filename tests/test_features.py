...
def test_player_experience():
    ...
    test_inputs = ["工击敌人", "atk", "我想打那个妖兽", "?"]  # 错别字  # 快捷键  # 自然语言  # 帮助
...
def test_narrative_system():
    ...
    # 测试成就系统
    player_stats = {"kills": 1, "level": 5, "cultivation_count": 10}
...
def test_ai_personalization():
    ...
    for action_type, target in actions:
        personalization_engine.record_player_action(player_id, action_type, target)
