...
def example_formatted_output():
    ...
    # 菜单
    output_manager.menu(["继续修炼", "外出历练", "拜访长老", "查看任务", "系统设置"], "主菜单")
...
def example_filtering():
    ...
    console_important.add_filter(lambda msg: msg.priority.value >= MessagePriority.HIGH.value)
...
def example_custom_formatter():
    ...
    # 多个进度条
    print("\n--- 修炼进度 ---")
    realms = [("炼气期", 100, 100), ("筑基期", 80, 100), ("金丹期", 15, 100), ("元婴期", 0, 100)]
