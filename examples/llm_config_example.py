...
from xwe.core.nlp import LLMClient, NLPConfig, NLPProcessor
...
def example_nlp_processor():
    ...
    nlp_config = NLPConfig(
        ...
        llm_config={"api_key": os.getenv("DEEPSEEK_API_KEY", ""), "temperature": 0.7},
    ...
    combat_context = {
        "in_combat": True,
        "enemies": [{"name": "低阶妖兽", "health_percent": 0.7}],
