...
ROLL_DATA = {
    ...
    "spiritual_roots": {
        "types": {
            ...
            "penta": {
                ...
                "bonus": {"cultivation_speed": 0.6, "breakthrough_chance": 0.8, "all_element_affinity": 1.2}
            }
        },
        "elements": ["金", "木", "水", "火", "土"]
    },
    ...
    "destinies": {
        ...
        "福星高照": {
            ...
            "effects": {
                "luck": 2,
                "injury_reduction": 0.9,
                "daily_resource_bonus": 1.2
            }
        },
        "文曲星君": {
            "weight": 12,
    ...
    "character_creation": {
        "name_generation": {
            "surnames": ["李", "王", "张", "刘", "陈", "杨", "赵", "黄", "周", "吴", "徐", "孙", "马", "胡", "郭", "林", "何", "高", "罗", "郑"],
            "male_names": ["天", "龙", "云", "风", "雷", "阳", "明", "浩", "宇", "辰", "轩", "峰", "杰", "涛", "然", "晨", "烨", "霆", "泽", "瀚"],
            "female_names": ["雪", "月", "霜", "梦", "瑶", "琳", "婷", "燕", "莲", "凤", "芸", "菲", "诗", "韵", "灵", "妍", "玥", "曦", "萱", "蝶"]
        }
    }
}
