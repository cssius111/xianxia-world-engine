...
from xwe_v2.core.command import CommandContext  # 处理器
from xwe_v2.core.command import (
...
from xwe_v2.core.command_parser import CommandType, ParsedCommand
from xwe_v2.core.output import ConsoleChannel, OutputManager
...
class TestCommandContext:
    ...
    def context(self):
        ...
        parsed_cmd = ParsedCommand(
            command_type=CommandType.ATTACK, target="敌人", raw_text="攻击 敌人"
        )
...
class TestCombatHandlers:
    ...
    def context(self):
        ...
        parsed_cmd = ParsedCommand(
            command_type=CommandType.ATTACK, target="妖兽", raw_text="攻击 妖兽"
        )
    ...
    def test_attack_handler(self, context):
        """测试攻击处理器"""
        from xwe_v2.core.command.handlers.combat_handler import AttackHandler
    ...
    def test_defend_handler(self, context):
        """测试防御处理器"""
        from xwe_v2.core.command.handlers.combat_handler import DefendHandler
    ...
    def test_flee_handler(self, context):
        """测试逃跑处理器"""
        from xwe_v2.core.command.handlers.combat_handler import FleeHandler
...
class TestSystemHandlers:
    ...
    def context(self):
        ...
        parsed_cmd = ParsedCommand(command_type=CommandType.SAVE, raw_text="保存")
    ...
    def test_save_handler(self, context):
        """测试保存处理器"""
        from xwe_v2.core.command.handlers.system_handler import SaveHandler
    ...
    def test_help_handler(self, context):
        """测试帮助处理器"""
        from xwe_v2.core.command.handlers.system_handler import HelpHandler
    ...
    def test_quit_handler(self, context):
        """测试退出处理器"""
        from xwe_v2.core.command.handlers.system_handler import QuitHandler
...
class TestInteractionHandlers:
    ...
    def context(self):
        ...
        parsed_cmd = ParsedCommand(
            command_type=CommandType.TALK, target="商人", raw_text="和 商人 说话"
        )
    ...
    def test_talk_handler(self, context):
        """测试对话处理器"""
        from xwe_v2.core.command.handlers.interaction_handler import TalkHandler
    ...
    def test_trade_handler(self, context):
        """测试交易处理器"""
        from xwe_v2.core.command.handlers.interaction_handler import TradeHandler
    ...
    def test_pickup_handler(self, context):
        """测试拾取处理器"""
        from xwe_v2.core.command.handlers.interaction_handler import PickUpHandler
...
class TestCultivationHandlers:
    ...
    def context(self):
        ...
        parsed_cmd = ParsedCommand(command_type=CommandType.CULTIVATE, raw_text="修炼")
    ...
    def test_cultivate_handler(self, context):
        """测试修炼处理器"""
        from xwe_v2.core.command.handlers.cultivation_handler import CultivateHandler
    ...
    def test_learn_skill_handler(self, context):
        """测试学习技能处理器"""
        from xwe_v2.core.command.handlers.cultivation_handler import LearnSkillHandler
    ...
    def test_breakthrough_handler(self, context):
        """测试突破处理器"""
        from xwe_v2.core.command.handlers.cultivation_handler import BreakthroughHandler
...
class TestIntegration:
    ...
    def test_full_command_flow(self):
        ...
        # 执行一系列命令
        commands = ["帮助", "状态", "修炼", "去 主城", "和 商人 说话", "保存 测试"]
