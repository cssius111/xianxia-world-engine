...
from xwe_v2.core.roll_system.roll_data import ROLL_DATA
from xwe_v2.core.roll_system.roll_utils import (
...
class CharacterRoller:
    ...
    def roll(self) -> RollResult:
        ...
        for _ in range(min(talent_count, len(available_talents))):
            talent_key, talent_data = weighted_random_choice(dict(available_talents))
        ...
        overall_rating = self._calculate_overall_rating(
            attributes,
            root_type_key,
            destiny_data.get("rarity", "common"),
            len(selected_talents),
