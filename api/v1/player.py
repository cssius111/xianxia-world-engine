...
def get_player_skills():
    ...
    return {"skills": skills_data, "skill_points": getattr(player, "skill_points", 0)}
...
def get_player_inventory():
    ...
    if not hasattr(game.player, "inventory"):
        return {"items": [], "capacity": {"used": 0, "total": 50}}
...
def get_player_achievements():
    ...
    return {"achievements": achievements_data, "total_points": total_points}
