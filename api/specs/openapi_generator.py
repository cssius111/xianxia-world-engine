...
class OpenAPIGenerator:
    ...
    def __init__(self, app: Flask = None):
        ...
        self.spec = {
            ...
            "info": {
                ...
                "version": "1.0.0",
                "contact": {"name": "XWE Team", "email": "support@xwe.example.com"},
            },
            "servers": [
        ...
        self.spec["components"]["schemas"].update(
            {
                "SuccessResponse": {
                    ...
                    "properties": {
                        ...
                        "timestamp": {"type": "number", "example": 1623456789.123},
                    },
                },
                "ErrorResponse": {
                    "type": "object",
    ...
    def _add_tags(self):
        """添加标签定义"""
        self.spec["tags"] = [
            {"name": "game", "description": "游戏核心功能"},
            {"name": "player", "description": "玩家信息管理"},
            {"name": "save", "description": "存档管理"},
            {"name": "system", "description": "系统信息"},
            {"name": "dev", "description": "开发调试工具"},
        ]
